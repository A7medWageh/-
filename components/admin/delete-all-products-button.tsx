      ...
      <DialogContent className="sm:max-w-md">
        {deleteStatus === 'success' ? (
          <div className="text-center py-6">
            ...
            <p className="text-sm text-muted-foreground mt-2">جميع المنتجات تم حذفها</p>
          </div>
        ) : (
          <>
            <DialogHeader>
              <DialogTitle className="text-right">حذف جميع المنتجات</DialogTitle>
            ...
            <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-4 flex gap-3 my-4">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  سيتم حذف جميع المنتجات بشكل نهائي. لا يمكن استرجاعها.
                </p>
              </div>
            </div>
